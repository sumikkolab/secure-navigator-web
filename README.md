...
- **AI 関連参考確認** — NIST AI RMF / ISO/IEC 42001 / 経産省 AI ガバナンス指針を参考にした確認結果を表示 [Pro]（参考確認であり、AI 利用の安全性やリスクを保証するものではありません）
...
| NIST CSF 2.0 適合評価 | — | ✓ |
| AI 関連参考確認（NIST AI RMF / ISO/IEC 42001 / 経産省 AI ガバナンス指針 を参考にした確認結果の表示） | — | ✓ |
| 高度な分析（成熟度詳細・原因と対策） | — | ✓ |
| ATT&CK テクニック詳細分析 | — | ✓ |
| PDF レポート出力 | — | ✓ |
